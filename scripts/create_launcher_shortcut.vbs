...
If WScript.Arguments.Count <> 1 Then
    WScript.Echo "Expected the LinguaMCP project directory."
    WScript.Quit 1
End If
...
shortcutPath = desktop & "\LinguaMCP MCP.lnk"
...
shortcut.Description = "Start and stop the LinguaMCP MCP server"
